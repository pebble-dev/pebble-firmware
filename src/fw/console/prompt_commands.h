...
extern void command_bt_conn_param_set(char *interval_min_ms, char *interval_max_ms,
                                      char *slave_latency, char *timeout_ms);
...
extern void command_btle_test_le_tx_start(char *tx_channel, char *tx_packet_length,
                                          char *packet_payload_type);
