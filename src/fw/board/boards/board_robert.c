...
static UARTDevice ACCESSORY_UART_DEVICE = {.state = &s_accessory_uart_state,
                                           .half_duplex = true,
                                           .tx_gpio =
                                               {
...
static const I2CBus I2C_TOUCH_ALS_BUS = {.state = &I2C_TOUCH_ALS_BUS_STATE,
...
static const I2CBus I2C_HRM_BUS = {.state = &I2C_HRM_BUS_STATE,
                                   .hal = &I2C_HRM_BUS_HAL,
                                   .scl_gpio = {.gpio = GPIOF,
                                                .gpio_pin = GPIO_Pin_1,
                                                .gpio_pin_source = GPIO_PinSource1,
...
static const I2CBus I2C_NFC_BUS = {.state = &I2C_NFC_BUS_STATE,
                                   .hal = &I2C_NFC_BUS_HAL,
                                   .scl_gpio = {.gpio = GPIOA,
                                                .gpio_pin = GPIO_Pin_8,
                                                .gpio_pin_source = GPIO_PinSource8,
...
static const I2CBus I2C_PMIC_MAG_BUS = {.state = &I2C_PMIC_MAG_BUS_STATE,
...
#if BOARD_CUTTS_BB
static const I2CSlavePort I2C_SLAVE_EWD1000 = {.bus = &I2C_TOUCH_ALS_BUS, .address = 0x2A};
#endif

static const I2CSlavePort I2C_SLAVE_MAX14690 = {.bus = &I2C_PMIC_MAG_BUS, .address = 0x50};

static const I2CSlavePort I2C_SLAVE_MAG3110 = {.bus = &I2C_PMIC_MAG_BUS, .address = 0x0e << 1};

static const I2CSlavePort I2C_SLAVE_AS7000 = {.bus = &I2C_HRM_BUS, .address = 0x60};
...
static HRMDevice HRM_DEVICE = {
    ...
    .int_gpio = {.gpio = GPIOI, .gpio_pin = GPIO_Pin_10},
    .en_gpio =
        {
            .gpio = GPIOF,
            .gpio_pin = GPIO_Pin_3,
...
static const VoltageMonitorDevice VOLTAGE_MONITOR_TEMPERATURE_DEVICE = {
    .adc = ADC1, .adc_channel = ADC_Channel_TempSensor, .clock_ctrl = RCC_APB2Periph_ADC1,
...
static SPISlavePort BMI160_SPI_SLAVE_PORT = {
    ...
    .spi_scs = {.gpio = GPIOI, .gpio_pin = GPIO_Pin_0, .active_high = false},
...
static SPISlavePort ICE40LP_SPI_SLAVE_PORT = {
    ...
    .spi_scs = {.gpio = GPIOA, .gpio_pin = GPIO_Pin_4, .active_high = false},
...
static SPISlavePort DIALOG_SPI_SLAVE_PORT = {.slave_state = &DIALOG_SPI_SLAVE_PORT_STATE,
...
void board_early_init(void) { spi_slave_port_init(ICE40LP->spi_port); }
