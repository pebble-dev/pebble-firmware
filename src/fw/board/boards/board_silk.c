...
static const I2CBus I2C_PMIC_HRM_BUS = {.state = &I2C_PMIC_HRM_BUS_STATE,
...
static const I2CSlavePort I2C_SLAVE_AS3701B = {.bus = &I2C_PMIC_HRM_BUS, .address = 0x80};

static const I2CSlavePort I2C_SLAVE_AS7000 = {.bus = &I2C_PMIC_HRM_BUS, .address = 0x60};
...
static HRMDevice HRM_DEVICE = {
    ...
    .int_gpio = {.gpio = GPIOA, .gpio_pin = GPIO_Pin_15},
    .en_gpio =
        {
            .gpio = GPIOC,
            .gpio_pin = GPIO_Pin_1,
