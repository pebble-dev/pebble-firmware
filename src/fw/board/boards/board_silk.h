    ...
    .buttons =
        {
            ...
            [BUTTON_ID_UP] = {"Up", GPIOD, GPIO_Pin_2, {EXTI_PortSourceGPIOD, 2}, GPIO_PuPd_DOWN},
            [BUTTON_ID_SELECT] =
...
static const BoardConfigAccel BOARD_CONFIG_ACCEL = {
    ...
    .accel_ints = {[0] = {EXTI_PortSourceGPIOA, 6}, [1] = {EXTI_PortSourceGPIOA, 3}},
};
