    ...
    .buttons =
        {
            ...
            [BUTTON_ID_BACK] = {"Back", GPIOG, GPIO_Pin_6, {EXTI_PortSourceGPIOG, 6}, GPIO_PuPd_UP},
            [BUTTON_ID_UP] = {"Up", GPIOG, GPIO_Pin_3, {EXTI_PortSourceGPIOG, 3}, GPIO_PuPd_NOPULL},
            [BUTTON_ID_DOWN] = {"Down", GPIOG, GPIO_Pin_4, {EXTI_PortSourceGPIOG, 4}, GPIO_PuPd_UP},
#elif BOARD_ROBERT_EVT
            [BUTTON_ID_BACK] =
                {"Back", GPIOG, GPIO_Pin_3, {EXTI_PortSourceGPIOG, 3}, GPIO_PuPd_NOPULL},
            [BUTTON_ID_UP] = {"Up", GPIOG, GPIO_Pin_4, {EXTI_PortSourceGPIOG, 4}, GPIO_PuPd_UP},
            [BUTTON_ID_DOWN] = {"Down", GPIOG, GPIO_Pin_6, {EXTI_PortSourceGPIOG, 6}, GPIO_PuPd_UP},
#else
#error "Unknown board"
#endif
            [BUTTON_ID_SELECT] =
...
#error "Unknown board"
    ...
    .battery_vmon_scale =
        {
            // The PMIC divides the battery voltage by a ratio of 3:1 in order to move it down to a
            // voltage
            // our ADC is capable of reading. The battery voltage varies around 4V~ and we're only
            // capable
...
#error "Unknown board"
    ...
    .accel_ints = {[0] = {EXTI_PortSourceGPIOH, 15}, [1] = {EXTI_PortSourceGPIOH, 14}},
};
